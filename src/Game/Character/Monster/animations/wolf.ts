...
const walkAnimationMap: Record<Direction, AnimationConfig> = {
  up: { textureName: "wolf-u-walk", flipX: false },
  down: { textureName: "wolf-d-walk", flipX: false },
  left: { textureName: "wolf-s-walk", flipX: false, y: -3 },
  right: { textureName: "wolf-s-walk", flipX: true, y: -3 },
};

const deathAnimationMap: Record<Direction, AnimationConfig> = {
  up: { textureName: "wolf-u-death", flipX: false },
  down: { textureName: "wolf-d-death", flipX: false },
  left: { textureName: "wolf-s-death", flipX: false, y: -3 },
  right: { textureName: "wolf-s-death", flipX: true, y: -3 },
};

export function getWolfWalkForDirection(
  direction: Direction,
...
export function getWolfDeathForDirection(
  direction: Direction,
  size: keyof typeof MonsterSize
): AnimatedSprite {
