...
const walkAnimationMap: Record<Direction, AnimationConfig> = {
  up: { textureName: "orcLord-u-walk", flipX: false },
  down: { textureName: "orcLord-d-walk", flipX: false },
  left: { textureName: "orcLord-s-walk", flipX: false, y: -3 },
  right: { textureName: "orcLord-s-walk", flipX: true, y: -3 },
};

const deathAnimationMap: Record<Direction, AnimationConfig> = {
  up: { textureName: "orcLord-u-death", flipX: false },
  down: { textureName: "orcLord-d-death", flipX: false },
  left: { textureName: "orcLord-s-death", flipX: false, y: -3 },
  right: { textureName: "orcLord-s-death", flipX: true, y: -3 },
};

export function getOrcLordWalkForDirection(
  direction: Direction,
...
export function getOrcLordDeathForDirection(
  direction: Direction,
  size: keyof typeof MonsterSize
): AnimatedSprite {
